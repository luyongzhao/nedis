...
public class TestUtils {
    ...
    public static void cleanRedis(String hostName,int port) throws IOException, InterruptedException {
        NedisClient client = NedisClientBuilder.create().timeoutMs(100).connect(hostName, port)
                .sync().getNow();
        try {
