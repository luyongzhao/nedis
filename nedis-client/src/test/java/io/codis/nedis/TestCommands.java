...
import static io.codis.nedis.TestUtils.ERROR;
...
import static io.codis.nedis.util.NedisUtils.BYTES_COMPARATOR;
...
import static io.codis.nedis.util.NedisUtils.toBytesExclusive;
...
public class TestCommands {
    ...
    private static String hostName = "10.2.12.235";
